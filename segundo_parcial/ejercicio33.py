...
print('Error global para método del punto medio con h=1/10:',np.linalg.norm(w10[-1]-correct_y(1), np.inf))
print('Error global para método del punto medio con h=1/100:',np.linalg.norm(w100[-1]-correct_y(1), np.inf))
