...
# Ejercicio 3.4.1
wImp=odes.implicitEuler(prime_y,t0=t0,y0=y0,stepSize=1/2,stepNum=40)
...
#Ejercicio 3.4.2
wExp6=odes.explicitEuler(prime_y,t0=t0,y0=y0,stepSize=1/6,stepNum=120)
wExp5=odes.explicitEuler(prime_y,t0=t0,y0=y0,stepSize=1/5,stepNum=100)
wExp4=odes.explicitEuler(prime_y,t0=t0,y0=y0,stepSize=1/4,stepNum=80)
wExp2=odes.explicitEuler(prime_y,t0=t0,y0=y0,stepSize=1/2,stepNum=40)
...
#Ejercicio 3.4.3
wRK23_10=odes.RK23(prime_y,t0=t0,y0=y0,t=20,tol=0.1)
wRK23_100=odes.RK23(prime_y,t0=t0,y0=y0,t=20,tol=0.01)
